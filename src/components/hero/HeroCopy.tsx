...
const buttonBase =
  "hero-btn inline-flex w-full items-center justify-center gap-2 px-5 font-body text-[0.8125rem] font-semibold tracking-[0.08em] uppercase transition-[color,background-color,border-color,transform] duration-200 focus-visible:ring-2 focus-visible:ring-signal focus-visible:ring-offset-2 focus-visible:ring-offset-[#1C1F26] focus-visible:outline-none active:translate-y-px sm:text-sm lg:w-auto lg:min-w-[13rem] lg:px-6";
      ...
      <div className="hero-main">
        ...
        >
          <a
            ...
            className={`${buttonBase} bg-signal text-white hover:bg-[#c4191f] focus-visible:bg-[#c4191f] active:bg-[#a81419]`}
            data-hero-cta
          >
            <WhatsAppIcon />
          ...
          <a
            ...
            className={`${buttonBase} border border-white/80 bg-[#1C1F26]/55 text-white hover:border-white hover:bg-[#1C1F26]/72 focus-visible:border-white active:bg-[#1C1F26]/80`}
            data-hero-cta
          >
            Ver produtos
          </a>
